          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-700">
                ...
                <th className="px-8 py-5 text-xs font-black text-slate-400 uppercase tracking-widest text-center">Nº BI</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4 animate-fade overflow-y-auto">
          <div className="bg-white dark:bg-slate-800 w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden my-8">
            <div className="px-6 py-5 bg-primary text-white flex items-center justify-between sticky top-0 z-10">
              <h3 className="text-lg font-bold">{editingUser ? 'Atualizar Perfil' : 'Cadastrar Usuário'}</h3>
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-black text-slate-400 uppercase mb-1">Nº Processo</label>
                ...
                <div>
                  <label className="block text-xs font-black text-slate-400 uppercase mb-1">Nº do BI</label>
              ...
              {formData.role === UserRole.PROFESSOR && (
                <div className="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-700 space-y-3">
                  <h4 className="text-xs font-bold text-primary uppercase">Funções de Coordenação</h4>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        placeholder={formData.coordinatorType === 'curso' ? 'Ex: Informática' : 'Ex: 12 A'}
